        ...
        <BrowserRouter>
            <MDBFooter color="blue-grey" className="page-footer font-small lighten-5 pt-0">
                ...
                <MDBContainer className="mt-5 mb-4 text-center text-md-left">
                    <MDBRow className="mt-3">
                        <MDBCol md="3" lg="3    " xl="3" className="mb-4 dark-grey-text">
                            ...
                            <p>
                               The purpose of AgriTech is to provide a online marketplace between the farmers and restaurants.
                               As the farmers are not getting a fair price for their goods because of contractors. This app removes the requirement of contractors for farmers. 
                               Farmers can sell their require needs to restaurants.
                            </p>
                        </MDBCol>
                        <MDBCol md="2" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <p><Link to="/consumer" className="dark-grey-text">RESTAURANTS </Link></p>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> Indore, India</p>
                            <p><i className="fa fa-envelope mr-3" /> info@example.com</p>
                            <p><i className="fa fa-phone mr-3" /> 9998877766</p>
                            <p><i className="fa fa-print mr-3" /> 8899955666 </p>
                        </MDBCol>
                ...
                <div className="footer-copyright text-center py-3">
                    ...
                    Akshat Gupta, Anekant Singhai, Avni Sharma, Chevi Parsai and Pragati Gupta
                </MDBContainer>
                </div>
            </MDBFooter>
        </BrowserRouter>
